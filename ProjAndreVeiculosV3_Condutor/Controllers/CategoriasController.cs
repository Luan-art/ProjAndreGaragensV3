...
namespace ProjAndreVeiculosV3_Condutor.Controllers
{
    ...
    public class CategoriasController : ControllerBase
    {
        ...
        public CategoriasController(ProjAndreVeiculosV3_CondutorContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Categoria>> PostCategoria(Categoria categoria)
        {
          if (_context.Categoria == null)
          {
              return Problem("Entity set 'ProjAndreVeiculosV3_CondutorContext.Categoria'  is null.");
          }
