...
namespace ProjAndreVeiculosV3_CarroServico.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class CarroServicoesController : ControllerBase
    {
        private readonly ProjAndreVeiculosV3_CarroServicoContext _context;

        public CarroServicoesController(ProjAndreVeiculosV3_CarroServicoContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<CarroServico>> PostCarroServico(CarroServicoDTO carroServicoDTO)
        {
          if (_context.CarroServico == null)
          {
              return Problem("Entity set 'ProjAndreVeiculosV3_CarroServicoContext.CarroServico'  is null.");
          }
