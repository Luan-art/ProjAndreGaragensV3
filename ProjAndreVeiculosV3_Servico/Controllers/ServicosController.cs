...
namespace ProjAndreVeiculosV3_Servico.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class ServicosController : ControllerBase
    {
        private readonly ProjAndreVeiculosV3_ServicoContext _context;

        public ServicosController(ProjAndreVeiculosV3_ServicoContext context)
        {
            _context = context;
        }
